...
<body>   
    ...
    <div style="position: fixed;bottom:0;right:0;z-index:1;display:flex" id="zooming-buttons">
        <button class="btn btn-custom btn-sm" style="background: #9ca9ab" onclick="zoomIn()"><i class="fa-solid fa-magnifying-glass-plus"></i></button> 
        <input type="number" id="zoom-precent" class="form-control" style="width: 90px" onchange="change_zoom()">
        <button class="btn btn-custom btn-sm" style="background: #9ca9ab" onclick="zoomOut()"><i class="fa-solid fa-magnifying-glass-minus"></i></button>
    </div>
