...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.companyPackage.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.company-packages.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_of_users') ? 'is-invalid' : '' }}" type="number" name="num_of_users" id="num_of_users" value="{{ old('num_of_users', '') }}" step="1" required>
