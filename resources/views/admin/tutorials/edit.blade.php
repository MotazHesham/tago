    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tutorials.update", [$tutorial->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $tutorial->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('iframe') ? 'is-invalid' : '' }}" name="iframe" id="iframe" required>{{ old('iframe', $tutorial->iframe) }}</textarea>
