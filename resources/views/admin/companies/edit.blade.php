                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('company_email') ? 'is-invalid' : '' }}" type="email"
                                    name="company_email" id="email" value="{{ old('company_email', $company->email) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $company->address) }}</textarea>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control {{ $errors->has('additional_info') ? 'is-invalid' : '' }}" name="additional_info"
                                    id="additional_info">{{ old('additional_info', $company->additional_info) }}</textarea>
                            ...
                            <div class="form-group col-md-12">
                                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="active" id="active"
                                        value="1" {{ $company->active || old('active', 0) === 1 ? 'checked' : '' }}>
