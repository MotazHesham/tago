...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#user_user_links" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="user_user_links">
            @includeIf('admin.users.relationships.userUserLinks', ['userLinks' => $user->userUserLinks])
        </div>
        <div class="tab-pane" role="tabpanel" id="user_connections">
            @includeIf('admin.users.relationships.userConnections', ['connections' => $user->userConnections])
        </div>
