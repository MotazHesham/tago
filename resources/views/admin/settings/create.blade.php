        ...
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <textarea class="form-control {{ $errors->has('why_us') ? 'is-invalid' : '' }}" name="why_us" id="why_us" required>{{ old('why_us') }}</textarea>
                ...
                <div class="form-group col-md-4">
                    ...
                    <textarea class="form-control {{ $errors->has('our_mission') ? 'is-invalid' : '' }}" name="our_mission" id="our_mission" required>{{ old('our_mission') }}</textarea>
                ...
                <div class="form-group col-md-4">
                    ...
                    <textarea class="form-control {{ $errors->has('how_it_work_description') ? 'is-invalid' : '' }}" name="how_it_work_description" id="how_it_work_description" required>{{ old('how_it_work_description') }}</textarea>
                ...
                <div class="form-group col-md-4">
                    ...
                    <textarea class="form-control {{ $errors->has('how_it_work') ? 'is-invalid' : '' }}" name="how_it_work" id="how_it_work" required>{{ old('how_it_work') }}</textarea>
                ...
                <div class="form-group col-md-4">
                    ...
                    <textarea class="form-control {{ $errors->has('contact_description') ? 'is-invalid' : '' }}" name="contact_description" id="contact_description" required>{{ old('contact_description') }}</textarea>
                ...
                <div class="form-group col-md-4">
                    <label class="required"
                        for="author_seo">{{ trans('cruds.setting.fields.author_seo') }}</label>
